...
# for this one I am doing no boundary penalties, and I am reducing the targets
# to what is obtainable when using prioritizr with min_set_objective
...
BLM = 0 #set to 1 or 0. Actual BLM is set in zoneboundcost if this is 1.
